...
if counter == duration:
        try:
            ...
            eth_value = data["ethereum"]["usd"]
            y = top
            draw.text((x,y),"Refreshing in: ", str(counter), font=small_font, fill=purple)
            ...
            draw.text((0+font.getsize("Value: ")[0],90), "${:.2f} ${:.2f}".format(eth_value*miner_data["unpaid"], eth_value), font=big_font, fill=green)
            y += font_height
