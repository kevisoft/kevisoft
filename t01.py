...
disp = ili9341.ili9341(spi, cs=digitalio.DigitalInOut(CS_PIN), dc=digitalio.DigitalInOut(DC_PIN)), rst=reset_pin, baudrate=BAUDRATE,
                     width=320, height=480, x_offset=53, y_offset=40)
