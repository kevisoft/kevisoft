...
y += font_height
draw.text((x,250),"Workers: Mh/s (R/A):", font=font, fill=blue)
y += font_height
draw.text((x,250), "{}: {:.1f} / ".format(miner_data["workers"], miner_data["reported_hashrate"]), font=font, fill=green)
...
y += font_height
draw.text((x,480), str(counter), font=small_font, fill=yellow)
