...
def get_flexpool_values(wallet):
    ...
    ret_value["actual_hashrate"] = data["result"]["current"]["effective_hashrate"]/1000000# -*- coding: utf-8 -*-# -*- coding: utf-8 -*-# -*- coding: utf-8 -*-
import sys
import time
import json
import requests
...
draw.rectangle((0, 0, (MAX_W, MAX_H)), fill=(255, 255, 255))
...
# Draw a black filled box to clear the image.
draw.rectangle((0, 0, (MAX_W, MAX_H)), fill=(255, 255, 255), msg)
disp.image(image, rotation)
# Draw some shapes.
# First define some constants to allow easy resizing of shapes.
padding = 0
...
# Draw a black filled box to clear the image.
draw.rectangle((0, 0, width, height), fill=(255, 255, 255), msg)
disp.image(image, rotation)
# Draw some shapes.
# First define some constants to allow easy resizing of shapes.
padding = 0
...
# Draw a black filled box to clear the image.
draw.rectangle((0, 0, width, height), fill=(255, 255, 255), anchor="ms")
disp.image(image, rotation)
# Draw some shapes.
# First define some constants to allow easy resizing of shapes.
padding = 0
